      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="bg-white rounded-3xl p-8 shadow-xl">
                ...
                {contactInfo.map((info, index) => (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-slate-800 font-semibold">{info.detail}</div>
                    </div>
                  </a>
                ))}
              </div>
              ...
              <div className="mt-8 p-6 bg-gradient-to-br from-orange-500/10 to-orange-600/10 rounded-2xl border border-orange-200">
                <div className="flex items-center mb-3">
                  ...
                  <span className="text-slate-800 font-semibold">Quick Response</span>
                </div>
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-3xl p-8 shadow-xl">
              <h3 className="text-2xl font-bold text-slate-800 mb-8">Start Your Project</h3>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <label htmlFor="project" className="block text-slate-700 font-medium mb-2">
                      Project Type
                    </label>
                    <select
                      id="project"
